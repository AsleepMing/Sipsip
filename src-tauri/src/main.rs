...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app::commands::delete_clipboard_entries,
            app::commands::clear_clipboard_history,
            app::commands::clear_clipboard_history_by_mode,
            app::commands::clear_recent_clipboard_history,
            ...
            app::commands::list_snippets,
            app::commands::get_snippet_categories,
            app::commands::save_snippet,
            app::commands::delete_snippet,
            app::commands::copy_snippet,
            app::commands::paste_snippet,
            ...
            app::commands::save_custom_background,
            app::commands::export_settings_backup,
            app::commands::import_settings_backup,
