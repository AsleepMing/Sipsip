...
export const useNavigationSync = ({
  ...
  useEffect(() => {
    const shouldDisableNavigation = showSettings || showTagManager || showSnippetPanel || chatMode || showEmojiPanel;
  ...
  }, [showSettings, showTagManager, showSnippetPanel, chatMode, showEmojiPanel]);
};
