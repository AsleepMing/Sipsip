      ...
      invoke<Record<string, string>>("get_settings")
        .then((result) => {
          ...
          try {
            ...
            if (result["app.custom_background"] !== undefined) {
              localStorage.setItem("tiez_custom_background", result["app.custom_background"]);
            }
            if (result["app.custom_background_opacity"] !== undefined) {
              localStorage.setItem(
                "tiez_custom_background_opacity",
                result["app.custom_background_opacity"]
              );
            }
            if (result["app.surface_opacity"] !== undefined) {
              localStorage.setItem("tiez_surface_opacity", result["app.surface_opacity"]);
            }
          } catch {
