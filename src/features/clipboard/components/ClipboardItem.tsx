...
const ClipboardItem = ({
    ...
    const canSaveAsSnippet = item.content_type === "text" || item.content_type === "code" || item.content_type === "rich_text";
            ...
            <div className="item-meta">
                ...
                <div className="item-meta-right">
                    <div className="item-actions">
                        ...
                        {canSaveAsSnippet && onSaveAsSnippet && (
                            <button
                                className="btn-icon"
                                onClick={onSaveAsSnippet}
                                title={t('save_as_snippet') || "转为片段"}
                            >
                                <BookMarked size={12} />
                            </button>
                        )}
